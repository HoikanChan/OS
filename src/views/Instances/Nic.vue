<template>
  <div class="nic-content">
    <div class="operation-row dark" id="operation-row">
      <ul class="clear">
        <li>
      ...
      <Modal v-model="addNicModal" title="将网络添加到 VM" @on-ok="addNic">
    ...
    <div class="nic-list clear">
      <div class="nic-item" v-for="(item,index) in nicData" :class="item.isdefault?'default-nic-item':''">
        ...
        <div v-else class="nic-item-title" >
          网卡{{index+1}}
    ...
    <Modal v-model="ipSelectModal" title="Change IP address for NIC" @on-ok="updateVmNicIp">
