<template>
       <div class="CalculationOffering">
           ...
           <div class="data-list-row">
                <ul>
                    <li v-for="item in dataList" @mouseenter="showHoverInfo" @mouseleave="hideHoverInfo" @click="openaDetail(item.id)">
...
export default {
  ...
  methods:{
     //鼠标移进显示隐藏的信息
      ...
      openaDetail(itemId){
          // alert(itemId);
          this.$router.push({name:'openDetail', params: { itemId: itemId, type: 'cal'}});
      },
      //获取计算方案
