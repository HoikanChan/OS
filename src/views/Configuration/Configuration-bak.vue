       ...
       <div class="configuration">
           <div class="configuration-content">
               ...
               <div class="configuration-search">
                    <div class="searchBtn" v-on:click="openDialog">+添加方案</div>
...
export default {
  ...
  methods:{
      ...
      getCalculationScheme(){
          ...
          if(this.mykeyword != ""){
            ...
            this.$http.get("/client/api",{
              ...
              this.dataList = response.listserviceofferingsresponse.serviceoffering;
              this.loading = false;
          }.bind(this))
      },
      getSystemScheme(){
      ...
      getVpcScheme(){
        ...
        operaDetail(itemId){
            // alert(itemId);
            this.$router.push({name:'openDetail', params: { itemId: itemId, type: this.mytype}});
        },
        //新增窗口
        openDialog: function () {
            this.isShow = true;
